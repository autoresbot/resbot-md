...
// Setiap command memanggil efek TextPro yang berbeda (`/api/textpro/${command}`),
// jadi semuanya ditampilkan di .menu / .allmenu — bukan alias satu fitur.
export const MenuCommands = "all";
