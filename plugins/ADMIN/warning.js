...
export default {
  ...
  // CAMPURAN: warn/warning, listwarning/listwarn, dan
  // deletewarning/delwarning masing-masing adalah alias fitur yang sama,
  // sedangkan debugwarn fitur tersendiri. Jadi ditulis eksplisit.
  MenuCommands: ["warn", "listwarn", "delwarn", "debugwarn"],
  OnlyPremium: false,
  OnlyOwner: false,
};
