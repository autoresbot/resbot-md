...
import { success, danger, logCustom } from '../lib/utils.js';
...
async function start_app() {
  ...
  try {
    ...
    console.error('Gagal melakukan koneksi awal WhatsApp:', error.message);
    logCustom('error', `Initial connect failed: ${error.message}`, 'startup-connect-error.txt');
  }
}
